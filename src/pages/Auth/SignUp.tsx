...
const SignUp = () => {
  ...
  const [errZip, setErrZip] = useState<string>("");
  // ============= Error Msg End here ===================
  ...
  return (
    <div className="w-full h-screen flex items-center justify-start z-997 absolute top-0 bg-[#F5F5F3] left-0 fixed">
